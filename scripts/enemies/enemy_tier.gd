...
const TIER_DATA = {
	1: [7,   100, 0.0, 2,  1, Color(0.42, 0.95, 1.0)],
	2: [15,  90,  0.0, 4,  1, Color(0.55, 1.0, 0.68)],
	3: [30,  80,  0.1, 7,  1, Color(0.5, 0.62, 1.0)],
	4: [60,  70,  0.2, 12, 2, Color(0.76, 0.46, 1.0)],
	5: [120, 60,  0.3, 20, 3, Color(1.0, 0.52, 0.28)],
}
